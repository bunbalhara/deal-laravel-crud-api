            ...
            <form method="post" action="{{route('admin.location.store')}}">
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input type="text" name="locationName" placeholder="Location Name" class="form-control" required/>
                    </div>
                    <div class="form-group col-md-6  col-12">
                        <label>Location About</label>
                        <textarea type="text" name="locationAbout" placeholder="Location About" class="form-control" required></textarea>
                    </div>
                    <div class=" col-md-6  col-12">
                        <label>Location Photo</label>
                        <div class="input-group">
                            <input type="text" name="locationPhoto" class="form-control" required/>
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea  name="blob" class="form-control m-input " id="locationBlob" rows="3"></textarea>
                    </div>
                </div>
                <hr />
